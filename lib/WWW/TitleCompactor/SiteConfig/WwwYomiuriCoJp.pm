package WWW::TitleCompactor::SiteConfig::WwwYomiuriCoJp;
use strict;
use warnings;
use utf8;
...
__PACKAGE__->category(qr/\w\w|ニュース|北海道|経済ニュース|マネー・経済|エンタメ|子ども|医療と介護|最前線|ネット＆デジタル|家族・友人|人生案内/);
